...
-- Q5. Which products have the most bad or okay reviews? 
SELECT item_purchased, COUNT(*) AS total_reviews
FROM customer
WHERE rating_category = 'bad'
GROUP BY item_purchased
ORDER BY count(*) DESC
LIMIT 10;
...
-- Q12. What are the top 10 cities with the highest purchase amounts?
SELECT SUM(purchase_amount), location
FROM customer
Group BY location
ORDER BY SUM(purchase_amount) DESC
LIMIT 10;

SELECT SUM(purchase_amount), shipping_type
FROM customer
Group BY shipping_type
ORDER BY SUM(purchase_amount) DESC
LIMIT 10;